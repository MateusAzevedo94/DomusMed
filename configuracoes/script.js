...
async function initializeApp() {
  ...
  try {
    ...
    // 3. Cria modal para visualização de imagens
    createImageModal();
    
    // 4. Cria elementos de interface dinamicamente
    createProgressBar();
    createToggleButton();
    createSidebar();
    
    // 5. Gera sumário automaticamente
    generateSummary();
    
    // 6. Configura event listeners
    setupEventListeners();
    
    // 7. Configura event listeners para imagens do corpo do texto
...
function reinitialize() {
  ...
  // Reconfigura event listeners das imagens
  setupImageModalListeners();
